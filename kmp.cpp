...
int main(void) {
    ...
    stream_test("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", 100, "aaaaaaaaaaaaaaaaaaaa", 20, correct);
    correct = (int*)realloc(correct, 94 * sizeof(int));
    for (int i = 0; i < 94; i++) {
        correct[i] = -1;
    }
